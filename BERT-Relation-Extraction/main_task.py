...
if __name__ == "__main__":
	...
	parser.add_argument("--num_samples", type=int, default=300, help="No of samples for evaluation")
	...
	parser.add_argument("--use_predefined_cls", action="store_true", help="Whether to use predefined labels such as PPIm.")
