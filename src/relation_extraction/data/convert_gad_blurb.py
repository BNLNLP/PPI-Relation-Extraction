"""
This code converts the GAD format from Biomedical Language Understanding and Reasoning Benchmark (BLURB) to the format that fits to the model. 01-11-2022

- GAD has a single label for a sentence.

ref: https://microsoft.github.io/BLURB/tasks.html#dataset_gad
...
data_dir = os.path.join(current_working_dir, 'datasets/data_generation/data/GAD')
out_dir = os.path.join(current_working_dir, 'datasets/GAD_BLURB')

entity_type_file = os.path.join(current_working_dir, 'datasets/GAD_BLURB/entity_types.json')
